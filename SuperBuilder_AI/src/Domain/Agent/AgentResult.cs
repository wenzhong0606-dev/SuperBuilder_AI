...
/// <summary>
/// Agent 编排结果（P9.2 AgentPlanner）。
///
/// <para>统一承载两条编排路径的产物：</para>
/// <list type="bullet">
/// <item><see cref="PlanFromIntentAsync"/>（默认路径，确定性、不调用 LLM）—— <see cref="UsedAi"/> 为 false。</item>
...
public sealed class AgentResult
{
	...
	/// <summary>成功时生成的 <see cref="AgentPlan"/> 实体（已填充 TenantId / Code / Name / DslJson 等）。</summary>
	...
	public static AgentResult Ok(AgentPlan plan, string dslJson, bool usedAi = false)
	...
	public static AgentResult Fail(IReadOnlyList<string> errors, bool usedAi = false)
