...
public static class ResourceKeys
{
    ...
    public static class Content
    {
        ...
        public const string CommonDelete = "Content.CommonDelete";
        public const string CommonEdit = "Content.CommonEdit";
        public const string CommonSaveSuccess = "Content.CommonSaveSuccess";
        public const string IdentityDirectoryRename = "Content.IdentityDirectoryRename";
        public const string IdentityDirectoryRenameTitle = "Content.IdentityDirectoryRenameTitle";
        public const string IdentityDirectoryRenameHint = "Content.IdentityDirectoryRenameHint";
        public const string IdentityDirectoryEnable = "Content.IdentityDirectoryEnable";
        public const string IdentityDirectoryDisable = "Content.IdentityDirectoryDisable";
        public const string IdentityDirectoryEnabled = "Content.IdentityDirectoryEnabled";
        public const string IdentityDirectoryDisabled = "Content.IdentityDirectoryDisabled";
        public const string IdentityDirectoryDeleted = "Content.IdentityDirectoryDeleted";
        public const string IdentityDirectoryDeleteFailed = "Content.IdentityDirectoryDeleteFailed";
        public const string IdentityDirectoryNameRequired = "Content.IdentityDirectoryNameRequired";
        public const string IdentityDirectoryColDescription = "Content.IdentityDirectoryColDescription";
        public const string DataPoliciesDesc = "Content.DataPoliciesDesc";
        public const string DataPoliciesNew = "Content.DataPoliciesNew";
        public const string DataPoliciesEdit = "Content.DataPoliciesEdit";
        public const string DataPoliciesLoading = "Content.DataPoliciesLoading";
        public const string DataPoliciesStatTotal = "Content.DataPoliciesStatTotal";
        public const string DataPoliciesStatTotalSub = "Content.DataPoliciesStatTotalSub";
        public const string DataPoliciesStatEnabled = "Content.DataPoliciesStatEnabled";
        public const string DataPoliciesStatEnabledSub = "Content.DataPoliciesStatEnabledSub";
        public const string DataPoliciesStatDisabled = "Content.DataPoliciesStatDisabled";
        public const string DataPoliciesStatDisabledSub = "Content.DataPoliciesStatDisabledSub";
        public const string DataPoliciesStatDataSources = "Content.DataPoliciesStatDataSources";
        public const string DataPoliciesStatDataSourcesSub = "Content.DataPoliciesStatDataSourcesSub";
        public const string DataPoliciesPanelPolicies = "Content.DataPoliciesPanelPolicies";
        public const string DataPoliciesAllDataSources = "Content.DataPoliciesAllDataSources";
        public const string DataPoliciesAllStates = "Content.DataPoliciesAllStates";
        public const string DataPoliciesStateEnabled = "Content.DataPoliciesStateEnabled";
        public const string DataPoliciesStateDisabled = "Content.DataPoliciesStateDisabled";
        public const string DataPoliciesSearchPh = "Content.DataPoliciesSearchPh";
        public const string DataPoliciesEmptyTitle = "Content.DataPoliciesEmptyTitle";
        public const string DataPoliciesEmptyText = "Content.DataPoliciesEmptyText";
        public const string DataPoliciesEnable = "Content.DataPoliciesEnable";
        public const string DataPoliciesDisable = "Content.DataPoliciesDisable";
        public const string DataPoliciesNote = "Content.DataPoliciesNote";
        public const string DataPoliciesColDataSource = "Content.DataPoliciesColDataSource";
        public const string DataPoliciesColTable = "Content.DataPoliciesColTable";
        public const string DataPoliciesColColumn = "Content.DataPoliciesColColumn";
        public const string DataPoliciesColSubjectType = "Content.DataPoliciesColSubjectType";
        public const string DataPoliciesColSubject = "Content.DataPoliciesColSubject";
        public const string DataPoliciesColEffect = "Content.DataPoliciesColEffect";
        public const string DataPoliciesColCondition = "Content.DataPoliciesColCondition";
        public const string DataPoliciesColState = "Content.DataPoliciesColState";
        public const string DataPoliciesColOperator = "Content.DataPoliciesColOperator";
        public const string DataPoliciesColValue = "Content.DataPoliciesColValue";
        public const string DataPoliciesSubjectEveryone = "Content.DataPoliciesSubjectEveryone";
        public const string DataPoliciesSubjectUser = "Content.DataPoliciesSubjectUser";
        public const string DataPoliciesSubjectRole = "Content.DataPoliciesSubjectRole";
        public const string DataPoliciesSubjectAttribute = "Content.DataPoliciesSubjectAttribute";
        public const string DataPoliciesEffectAllow = "Content.DataPoliciesEffectAllow";
        public const string DataPoliciesEffectDeny = "Content.DataPoliciesEffectDeny";
        public const string DataPoliciesEffectAllowShort = "Content.DataPoliciesEffectAllowShort";
        public const string DataPoliciesEffectDenyShort = "Content.DataPoliciesEffectDenyShort";
        public const string DataPoliciesSelectDataSource = "Content.DataPoliciesSelectDataSource";
        public const string DataPoliciesSelectTable = "Content.DataPoliciesSelectTable";
        public const string DataPoliciesSelectColumn = "Content.DataPoliciesSelectColumn";
        public const string DataPoliciesSelectUser = "Content.DataPoliciesSelectUser";
        public const string DataPoliciesSelectRole = "Content.DataPoliciesSelectRole";
        public const string DataPoliciesSelectBinding = "Content.DataPoliciesSelectBinding";
        public const string DataPoliciesSelectSubject = "Content.DataPoliciesSelectSubject";
        public const string DataPoliciesNoTables = "Content.DataPoliciesNoTables";
        public const string DataPoliciesAttrKey = "Content.DataPoliciesAttrKey";
        public const string DataPoliciesAttrKeyPh = "Content.DataPoliciesAttrKeyPh";
        public const string DataPoliciesAttrKeyRequired = "Content.DataPoliciesAttrKeyRequired";
        public const string DataPoliciesAttrValue = "Content.DataPoliciesAttrValue";
        public const string DataPoliciesAttrValuePh = "Content.DataPoliciesAttrValuePh";
        public const string DataPoliciesValuePh = "Content.DataPoliciesValuePh";
        public const string DataPoliciesValueRequired = "Content.DataPoliciesValueRequired";
        public const string DataPoliciesNullValueHint = "Content.DataPoliciesNullValueHint";
        public const string DataPoliciesEnabled = "Content.DataPoliciesEnabled";
        public const string DataPoliciesCreated = "Content.DataPoliciesCreated";
        public const string DataPoliciesUpdated = "Content.DataPoliciesUpdated";
        public const string DataPoliciesSaveFailed = "Content.DataPoliciesSaveFailed";
        public const string DataPoliciesToggleFailed = "Content.DataPoliciesToggleFailed";
        public const string DataPoliciesDeleted = "Content.DataPoliciesDeleted";
        public const string DataPoliciesDeleteFailed = "Content.DataPoliciesDeleteFailed";
        ...
        public const string DashboardDesignerTitle = "Content.DashboardDesignerTitle";
        public const string DashboardDesignerDesc = "Content.DashboardDesignerDesc";
        public const string DashboardDesignerBack = "Content.DashboardDesignerBack";
        public const string DashboardDesignerModeDesign = "Content.DashboardDesignerModeDesign";
        public const string DashboardDesignerModeSource = "Content.DashboardDesignerModeSource";
        public const string DashboardDesignerModeHint = "Content.DashboardDesignerModeHint";
        public const string DashboardDesignerSourceTitle = "Content.DashboardDesignerSourceTitle";
        public const string DashboardDesignerSourceHint = "Content.DashboardDesignerSourceHint";
        public const string DashboardDesignerApply = "Content.DashboardDesignerApply";
        public const string DashboardDesignerApplyInvalid = "Content.DashboardDesignerApplyInvalid";
        public const string DashboardDesignerSave = "Content.DashboardDesignerSave";
        public const string DashboardDesignerSaving = "Content.DashboardDesignerSaving";
        public const string DashboardDesignerSaved = "Content.DashboardDesignerSaved";
        public const string DashboardDesignerSaveFailed = "Content.DashboardDesignerSaveFailed";
        public const string DashboardDesignerSaveFailedHttp = "Content.DashboardDesignerSaveFailedHttp";
        public const string DashboardDesignerPublish = "Content.DashboardDesignerPublish";
        public const string DashboardDesignerPublishing = "Content.DashboardDesignerPublishing";
        public const string DashboardDesignerPublished = "Content.DashboardDesignerPublished";
        public const string DashboardDesignerPublishFailed = "Content.DashboardDesignerPublishFailed";
        public const string DashboardDesignerPublishFailedHttp = "Content.DashboardDesignerPublishFailedHttp";
        public const string DashboardDesignerLoading = "Content.DashboardDesignerLoading";
        public const string DashboardDesignerLoadFailed = "Content.DashboardDesignerLoadFailed";
        public const string DashboardDesignerPalette = "Content.DashboardDesignerPalette";
        public const string DashboardDesignerPaletteHint = "Content.DashboardDesignerPaletteHint";
        public const string DashboardDesignerCanvas = "Content.DashboardDesignerCanvas";
        public const string DashboardDesignerCanvasEmpty = "Content.DashboardDesignerCanvasEmpty";
        public const string DashboardDesignerInspector = "Content.DashboardDesignerInspector";
        public const string DashboardDesignerInspectorEmpty = "Content.DashboardDesignerInspectorEmpty";
        public const string DashboardDesignerFieldTitle = "Content.DashboardDesignerFieldTitle";
        public const string DashboardDesignerFieldId = "Content.DashboardDesignerFieldId";
        public const string DashboardDesignerFieldPosition = "Content.DashboardDesignerFieldPosition";
        public const string DashboardDesignerFieldOrder = "Content.DashboardDesignerFieldOrder";
        public const string DashboardDesignerFieldQuestion = "Content.DashboardDesignerFieldQuestion";
        public const string DashboardDesignerFieldQuestionHint = "Content.DashboardDesignerFieldQuestionHint";
        public const string DashboardDesignerFieldChartType = "Content.DashboardDesignerFieldChartType";
        public const string DashboardDesignerFieldCategory = "Content.DashboardDesignerFieldCategory";
        public const string DashboardDesignerFieldValues = "Content.DashboardDesignerFieldValues";
        public const string DashboardDesignerFieldValuesHint = "Content.DashboardDesignerFieldValuesHint";
        public const string DashboardDesignerFieldSeries = "Content.DashboardDesignerFieldSeries";
        public const string DashboardDesignerFieldStacked = "Content.DashboardDesignerFieldStacked";
        public const string DashboardDesignerFieldLegend = "Content.DashboardDesignerFieldLegend";
        public const string DashboardDesignerFieldValue = "Content.DashboardDesignerFieldValue";
        public const string DashboardDesignerFieldFormat = "Content.DashboardDesignerFieldFormat";
        public const string DashboardDesignerFieldTarget = "Content.DashboardDesignerFieldTarget";
        public const string DashboardDesignerFieldContent = "Content.DashboardDesignerFieldContent";
        public const string DashboardDesignerFieldLevel = "Content.DashboardDesignerFieldLevel";
        public const string DashboardDesignerFieldMarkdown = "Content.DashboardDesignerFieldMarkdown";
        public const string DashboardDesignerFieldField = "Content.DashboardDesignerFieldField";
        public const string DashboardDesignerFieldControl = "Content.DashboardDesignerFieldControl";
        public const string DashboardDesignerFieldMultiple = "Content.DashboardDesignerFieldMultiple";
        public const string DashboardDesignerFieldShowTotal = "Content.DashboardDesignerFieldShowTotal";
        public const string DashboardDesignerFieldStriped = "Content.DashboardDesignerFieldStriped";
        public const string DashboardDesignerFieldPageSize = "Content.DashboardDesignerFieldPageSize";
        public const string DashboardDesignerFieldPrompt = "Content.DashboardDesignerFieldPrompt";
        public const string DashboardDesignerFieldMaxInsights = "Content.DashboardDesignerFieldMaxInsights";
        public const string DashboardDesignerFieldPerspective = "Content.DashboardDesignerFieldPerspective";
        public const string DashboardDesignerDelete = "Content.DashboardDesignerDelete";
        public const string DashboardDesignerDuplicate = "Content.DashboardDesignerDuplicate";
        public const string DashboardDesignerWidgetCount = "Content.DashboardDesignerWidgetCount";
        public const string DashboardDesignerDirty = "Content.DashboardDesignerDirty";
        public const string DashboardDesignerStatus = "Content.DashboardDesignerStatus";
        public const string DashboardDesignerRemoved = "Content.DashboardDesignerRemoved";
        public const string DashboardDesignerAdded = "Content.DashboardDesignerAdded";
        public const string DashboardDesignerDropped = "Content.DashboardDesignerDropped";
        public const string DashboardDesignerWidgetChart = "Content.DashboardDesignerWidgetChart";
        public const string DashboardDesignerWidgetTable = "Content.DashboardDesignerWidgetTable";
        public const string DashboardDesignerWidgetKpi = "Content.DashboardDesignerWidgetKpi";
        public const string DashboardDesignerWidgetFilter = "Content.DashboardDesignerWidgetFilter";
        public const string DashboardDesignerWidgetText = "Content.DashboardDesignerWidgetText";
        public const string DashboardDesignerWidgetAiInsight = "Content.DashboardDesignerWidgetAiInsight";
        ...
        public const string ComponentLibraryAssets = "Content.ComponentLibraryAssets";
        public const string ComponentLibraryLifecycleHint = "Content.ComponentLibraryLifecycleHint";
        public const string ComponentLibraryNew = "Content.ComponentLibraryNew";
        public const string ComponentLibraryEmptyTitle = "Content.ComponentLibraryEmptyTitle";
        public const string ComponentLibraryEmptyText = "Content.ComponentLibraryEmptyText";
        public const string ComponentLibraryType = "Content.ComponentLibraryType";
        public const string ComponentLibraryVersion = "Content.ComponentLibraryVersion";
        public const string ComponentLibraryPublishedAt = "Content.ComponentLibraryPublishedAt";
        public const string ComponentLibraryActions = "Content.ComponentLibraryActions";
        public const string ComponentLibraryPreview = "Content.ComponentLibraryPreview";
        public const string ComponentLibraryVersions = "Content.ComponentLibraryVersions";
        public const string ComponentLibraryPublish = "Content.ComponentLibraryPublish";
        public const string ComponentLibraryEditTitle = "Content.ComponentLibraryEditTitle";
        public const string ComponentLibraryKey = "Content.ComponentLibraryKey";
        public const string ComponentLibraryKeyHint = "Content.ComponentLibraryKeyHint";
        public const string ComponentLibraryDescription = "Content.ComponentLibraryDescription";
        public const string ComponentLibraryDsl = "Content.ComponentLibraryDsl";
        public const string ComponentLibraryDslHint = "Content.ComponentLibraryDslHint";
        public const string ComponentLibrarySaving = "Content.ComponentLibrarySaving";
        public const string ComponentLibraryPreviewTitle = "Content.ComponentLibraryPreviewTitle";
        public const string ComponentLibraryVersionHistory = "Content.ComponentLibraryVersionHistory";
        public const string ComponentLibraryNoVersions = "Content.ComponentLibraryNoVersions";
        public const string ComponentLibraryCurrent = "Content.ComponentLibraryCurrent";
        public const string ComponentLibraryRollback = "Content.ComponentLibraryRollback";
        public const string ComponentLibraryDeleteConfirm = "Content.ComponentLibraryDeleteConfirm";
        public const string ComponentLibraryLoadFailed = "Content.ComponentLibraryLoadFailed";
        public const string ComponentLibraryInvalidForm = "Content.ComponentLibraryInvalidForm";
        public const string ComponentLibraryInvalidDsl = "Content.ComponentLibraryInvalidDsl";
        public const string ComponentLibrarySaveFailed = "Content.ComponentLibrarySaveFailed";
        public const string ComponentLibrarySaved = "Content.ComponentLibrarySaved";
        public const string ComponentLibraryPublishFailed = "Content.ComponentLibraryPublishFailed";
        public const string ComponentLibraryPublished = "Content.ComponentLibraryPublished";
        public const string ComponentLibraryUnpublished = "Content.ComponentLibraryUnpublished";
        public const string ComponentLibraryRollbackFailed = "Content.ComponentLibraryRollbackFailed";
        public const string ComponentLibraryRollbackDone = "Content.ComponentLibraryRollbackDone";
        public const string ComponentLibraryDeleteFailed = "Content.ComponentLibraryDeleteFailed";
        public const string ComponentLibraryDeleted = "Content.ComponentLibraryDeleted";
        ...
        public const string AppsDesignerTitle = "Content.AppsDesignerTitle";
        public const string AppsDesignerLoading = "Content.AppsDesignerLoading";
        public const string AppsDesignerLoadFailed = "Content.AppsDesignerLoadFailed";
        public const string AppsDesignerSave = "Content.AppsDesignerSave";
        public const string AppsDesignerSaving = "Content.AppsDesignerSaving";
        public const string AppsDesignerSaved = "Content.AppsDesignerSaved";
        public const string AppsDesignerSaveFailed = "Content.AppsDesignerSaveFailed";
        public const string AppsDesignerPublish = "Content.AppsDesignerPublish";
        public const string AppsDesignerPublishing = "Content.AppsDesignerPublishing";
        public const string AppsDesignerPublished = "Content.AppsDesignerPublished";
        public const string AppsDesignerPublishFailed = "Content.AppsDesignerPublishFailed";
        public const string AppsDesignerDesignMode = "Content.AppsDesignerDesignMode";
        public const string AppsDesignerSourceMode = "Content.AppsDesignerSourceMode";
        public const string AppsDesignerAppName = "Content.AppsDesignerAppName";
        public const string AppsDesignerAppDescription = "Content.AppsDesignerAppDescription";
        public const string AppsDesignerTheme = "Content.AppsDesignerTheme";
        public const string AppsDesignerThemeDefault = "Content.AppsDesignerThemeDefault";
        public const string AppsDesignerTreeTitle = "Content.AppsDesignerTreeTitle";
        public const string AppsDesignerPages = "Content.AppsDesignerPages";
        public const string AppsDesignerAddPage = "Content.AppsDesignerAddPage";
        public const string AppsDesignerAddComponent = "Content.AppsDesignerAddComponent";
        public const string AppsDesignerDelete = "Content.AppsDesignerDelete";
        public const string AppsDesignerDuplicate = "Content.AppsDesignerDuplicate";
        public const string AppsDesignerNoSelection = "Content.AppsDesignerNoSelection";
        public const string AppsDesignerEmptyApp = "Content.AppsDesignerEmptyApp";
        public const string AppsDesignerSectionGeneral = "Content.AppsDesignerSectionGeneral";
        public const string AppsDesignerSectionBinding = "Content.AppsDesignerSectionBinding";
        public const string AppsDesignerSectionProperties = "Content.AppsDesignerSectionProperties";
        public const string AppsDesignerSectionStyle = "Content.AppsDesignerSectionStyle";
        public const string AppsDesignerSectionPermissions = "Content.AppsDesignerSectionPermissions";
        public const string AppsDesignerFieldType = "Content.AppsDesignerFieldType";
        public const string AppsDesignerFieldId = "Content.AppsDesignerFieldId";
        public const string AppsDesignerFieldTitle = "Content.AppsDesignerFieldTitle";
        public const string AppsDesignerFieldOrder = "Content.AppsDesignerFieldOrder";
        public const string AppsDesignerFieldPosition = "Content.AppsDesignerFieldPosition";
        public const string AppsDesignerFieldEntity = "Content.AppsDesignerFieldEntity";
        public const string AppsDesignerFieldDataSourceId = "Content.AppsDesignerFieldDataSourceId";
        public const string AppsDesignerFieldTableId = "Content.AppsDesignerFieldTableId";
        public const string AppsDesignerFieldMetrics = "Content.AppsDesignerFieldMetrics";
        public const string AppsDesignerFieldDimensions = "Content.AppsDesignerFieldDimensions";
        public const string AppsDesignerFieldFilters = "Content.AppsDesignerFieldFilters";
        public const string AppsDesignerFieldSort = "Content.AppsDesignerFieldSort";
        public const string AppsDesignerFieldLimit = "Content.AppsDesignerFieldLimit";
        public const string AppsDesignerFieldAggregation = "Content.AppsDesignerFieldAggregation";
        public const string AppsDesignerFieldOperator = "Content.AppsDesignerFieldOperator";
        public const string AppsDesignerFieldValue = "Content.AppsDesignerFieldValue";
        public const string AppsDesignerFieldDirection = "Content.AppsDesignerFieldDirection";
        public const string AppsDesignerFieldPalette = "Content.AppsDesignerFieldPalette";
        public const string AppsDesignerFieldBackground = "Content.AppsDesignerFieldBackground";
        public const string AppsDesignerFieldShowBorder = "Content.AppsDesignerFieldShowBorder";
        public const string AppsDesignerFieldPadding = "Content.AppsDesignerFieldPadding";
        public const string AppsDesignerTypeChart = "Content.AppsDesignerTypeChart";
        public const string AppsDesignerTypeTable = "Content.AppsDesignerTypeTable";
        public const string AppsDesignerTypeKpi = "Content.AppsDesignerTypeKpi";
        public const string AppsDesignerTypeText = "Content.AppsDesignerTypeText";
        public const string AppsDesignerTypeFilter = "Content.AppsDesignerTypeFilter";
        public const string AppsDesignerTypeForm = "Content.AppsDesignerTypeForm";
        public const string AppsDesignerPermissionsHint = "Content.AppsDesignerPermissionsHint";
        public const string AppsDesignerSourceHint = "Content.AppsDesignerSourceHint";
        public const string AppsDesignerSourceInvalid = "Content.AppsDesignerSourceInvalid";
        ...
        // M12-11：Agent 运行详情页文案
        public const string AgentRunTitle = "Content.AgentRunTitle";
        public const string AgentRunDesc = "Content.AgentRunDesc";
        public const string AgentRunLoadingText = "Content.AgentRunLoadingText";
        public const string AgentRunNotFound = "Content.AgentRunNotFound";
        public const string AgentRunLoadError = "Content.AgentRunLoadError";
        public const string AgentRunInfoPanel = "Content.AgentRunInfoPanel";
        public const string AgentRunPlanCode = "Content.AgentRunPlanCode";
        public const string AgentRunStatus = "Content.AgentRunStatus";
        public const string AgentRunActor = "Content.AgentRunActor";
        public const string AgentRunStarted = "Content.AgentRunStarted";
        public const string AgentRunFinished = "Content.AgentRunFinished";
        public const string AgentRunDuration = "Content.AgentRunDuration";
        public const string AgentRunResultSummary = "Content.AgentRunResultSummary";
        public const string AgentRunSteps = "Content.AgentRunSteps";
        public const string AgentRunNoSteps = "Content.AgentRunNoSteps";
        public const string AgentRunStepSucceeded = "Content.AgentRunStepSucceeded";
        public const string AgentRunStepFailed = "Content.AgentRunStepFailed";
        public const string AgentRunStepPendingApproval = "Content.AgentRunStepPendingApproval";
        public const string AgentRunStepAttempts = "Content.AgentRunStepAttempts";
        public const string AgentRunStepOutput = "Content.AgentRunStepOutput";
        public const string AgentRunStepError = "Content.AgentRunStepError";
        public const string AgentRunApprove = "Content.AgentRunApprove";
        public const string AgentRunReject = "Content.AgentRunReject";
        public const string AgentRunApproveSuccess = "Content.AgentRunApproveSuccess";
        public const string AgentRunRejectSuccess = "Content.AgentRunRejectSuccess";
        public const string AgentRunActionFailed = "Content.AgentRunActionFailed";
        public const string AgentRunStatusQueued = "Content.AgentRunStatusQueued";
        public const string AgentRunStatusRunning = "Content.AgentRunStatusRunning";
        public const string AgentRunStatusSucceeded = "Content.AgentRunStatusSucceeded";
        public const string AgentRunStatusFailed = "Content.AgentRunStatusFailed";
        public const string AgentRunStatusApprovalPending = "Content.AgentRunStatusApprovalPending";
        public const string AgentRunStatusApproved = "Content.AgentRunStatusApproved";
        public const string AgentRunStatusRejected = "Content.AgentRunStatusRejected";
        public const string AgentRunRiskSafe = "Content.AgentRunRiskSafe";
        public const string AgentRunRiskRead = "Content.AgentRunRiskRead";
        public const string AgentRunRiskWrite = "Content.AgentRunRiskWrite";
        public const string AgentRunModeControlled = "Content.AgentRunModeControlled";
        public const string AgentRunModeLive = "Content.AgentRunModeLive";
        ...
        public const string OnboardingTitle = "Content.OnboardingTitle";
        public const string OnboardingDesc = "Content.OnboardingDesc";
        public const string OnboardingProgress = "Content.OnboardingProgress";
        public const string OnboardingBlankTitle = "Content.OnboardingBlankTitle";
        public const string OnboardingBlankText = "Content.OnboardingBlankText";
        public const string OnbConnectTitle = "Content.OnbConnectTitle";
        public const string OnbConnectDesc = "Content.OnbConnectDesc";
        public const string OnbConnectFailed = "Content.OnbConnectFailed";
        public const string OnbScanTitle = "Content.OnbScanTitle";
        public const string OnbScanDesc = "Content.OnbScanDesc";
        public const string OnbScanRetry = "Content.OnbScanRetry";
        public const string OnbSemanticTitle = "Content.OnbSemanticTitle";
        public const string OnbSemanticDesc = "Content.OnbSemanticDesc";
        public const string OnbAskTitle = "Content.OnbAskTitle";
        public const string OnbAskDesc = "Content.OnbAskDesc";
        public const string OnbSaveTitle = "Content.OnbSaveTitle";
        public const string OnbSaveDesc = "Content.OnbSaveDesc";
        public const string OnbSampleTitle = "Content.OnbSampleTitle";
        public const string OnbSampleDesc = "Content.OnbSampleDesc";
        public const string OnbGo = "Content.OnbGo";
        public const string OnbDone = "Content.OnbDone";
        public const string OnbRetry = "Content.OnbRetry";
    ...
    public static class Nav
    {
        ...
        public const string DataPolicies = "Nav.DataPolicies";
    ...
    public static IReadOnlyDictionary<string, ResourceKeyMeta> Catalog { get; } = new Dictionary<string, ResourceKeyMeta>
    {
        ...
        [Page.DescComponentGallery] = new("Page", Page: "ComponentGallery", DefaultValue: "Create, publish, and reuse tenant components with a safe structured DSL."),
        ...
        [Content.CommonDelete] = new("Content", Page: "Common", DefaultValue: "Delete"),
        [Content.CommonEdit] = new("Content", Page: "Common", DefaultValue: "Edit"),
        [Content.CommonSaveSuccess] = new("Content", Page: "Common", DefaultValue: "Saved."),
        [Content.IdentityDirectoryRename] = new("Content", Page: "IdentityDirectory", DefaultValue: "Rename"),
        [Content.IdentityDirectoryRenameTitle] = new("Content", Page: "IdentityDirectory", DefaultValue: "Rename"),
        [Content.IdentityDirectoryRenameHint] = new("Content", Page: "IdentityDirectory", DefaultValue: "The code cannot be changed after creation; disabling or deleting affects related objects."),
        [Content.IdentityDirectoryEnable] = new("Content", Page: "IdentityDirectory", DefaultValue: "Enable"),
        [Content.IdentityDirectoryDisable] = new("Content", Page: "IdentityDirectory", DefaultValue: "Disable"),
        [Content.IdentityDirectoryEnabled] = new("Content", Page: "IdentityDirectory", DefaultValue: "Enabled."),
        [Content.IdentityDirectoryDisabled] = new("Content", Page: "IdentityDirectory", DefaultValue: "Disabled."),
        [Content.IdentityDirectoryDeleted] = new("Content", Page: "IdentityDirectory", DefaultValue: "Deleted: {0}."),
        [Content.IdentityDirectoryDeleteFailed] = new("Content", Page: "IdentityDirectory", DefaultValue: "Delete failed (HTTP {0})."),
        [Content.IdentityDirectoryNameRequired] = new("Content", Page: "IdentityDirectory", DefaultValue: "Name is required."),
        [Content.IdentityDirectoryColDescription] = new("Content", Page: "IdentityDirectory", DefaultValue: "Description"),
        [Content.DataPoliciesDesc] = new("Content", Page: "DataPolicies", DefaultValue: "Centrally manage row-level security (RLS) policies: restrict which rows a user or role can see per data source / table / column."),
        [Content.DataPoliciesNew] = new("Content", Page: "DataPolicies", DefaultValue: "New policy"),
        [Content.DataPoliciesEdit] = new("Content", Page: "DataPolicies", DefaultValue: "Edit policy"),
        [Content.DataPoliciesLoading] = new("Content", Page: "DataPolicies", DefaultValue: "Loading data policies…"),
        [Content.DataPoliciesStatTotal] = new("Content", Page: "DataPolicies", DefaultValue: "Total policies"),
        [Content.DataPoliciesStatTotalSub] = new("Content", Page: "DataPolicies", DefaultValue: "All row policies in this tenant"),
        [Content.DataPoliciesStatEnabled] = new("Content", Page: "DataPolicies", DefaultValue: "Enabled"),
        [Content.DataPoliciesStatEnabledSub] = new("Content", Page: "DataPolicies", DefaultValue: "Applied as a mandatory query filter"),
        [Content.DataPoliciesStatDisabled] = new("Content", Page: "DataPolicies", DefaultValue: "Disabled"),
        [Content.DataPoliciesStatDisabledSub] = new("Content", Page: "DataPolicies", DefaultValue: "Kept but not applied"),
        [Content.DataPoliciesStatDataSources] = new("Content", Page: "DataPolicies", DefaultValue: "Data sources covered"),
        [Content.DataPoliciesStatDataSourcesSub] = new("Content", Page: "DataPolicies", DefaultValue: "At least one policy"),
        [Content.DataPoliciesPanelPolicies] = new("Content", Page: "DataPolicies", DefaultValue: "Row-level security policies"),
        [Content.DataPoliciesAllDataSources] = new("Content", Page: "DataPolicies", DefaultValue: "All data sources"),
        [Content.DataPoliciesAllStates] = new("Content", Page: "DataPolicies", DefaultValue: "All states"),
        [Content.DataPoliciesStateEnabled] = new("Content", Page: "DataPolicies", DefaultValue: "Enabled"),
        [Content.DataPoliciesStateDisabled] = new("Content", Page: "DataPolicies", DefaultValue: "Disabled"),
        [Content.DataPoliciesSearchPh] = new("Content", Page: "DataPolicies", DefaultValue: "Search table / column / subject / value…"),
        [Content.DataPoliciesEmptyTitle] = new("Content", Page: "DataPolicies", DefaultValue: "No row-level security policies"),
        [Content.DataPoliciesEmptyText] = new("Content", Page: "DataPolicies", DefaultValue: "After a policy is created, matching queries get a mandatory filter appended; disabling keeps the policy but stops it from applying."),
        [Content.DataPoliciesEnable] = new("Content", Page: "DataPolicies", DefaultValue: "Enable"),
        [Content.DataPoliciesDisable] = new("Content", Page: "DataPolicies", DefaultValue: "Disable"),
        [Content.DataPoliciesNote] = new("Content", Page: "DataPolicies", DefaultValue: "Policies apply at query time and never modify physical data; operators come from a controlled vocabulary and values are parameterized. This page manages row-level policies only: column-level (field) authorization is not available yet."),
        [Content.DataPoliciesColDataSource] = new("Content", Page: "DataPolicies", DefaultValue: "Data source"),
        [Content.DataPoliciesColTable] = new("Content", Page: "DataPolicies", DefaultValue: "Table"),
        [Content.DataPoliciesColColumn] = new("Content", Page: "DataPolicies", DefaultValue: "Column"),
        [Content.DataPoliciesColSubjectType] = new("Content", Page: "DataPolicies", DefaultValue: "Subject type"),
        [Content.DataPoliciesColSubject] = new("Content", Page: "DataPolicies", DefaultValue: "Subject"),
        [Content.DataPoliciesColEffect] = new("Content", Page: "DataPolicies", DefaultValue: "Effect"),
        [Content.DataPoliciesColCondition] = new("Content", Page: "DataPolicies", DefaultValue: "Condition"),
        [Content.DataPoliciesColState] = new("Content", Page: "DataPolicies", DefaultValue: "State"),
        [Content.DataPoliciesColOperator] = new("Content", Page: "DataPolicies", DefaultValue: "Operator"),
        [Content.DataPoliciesColValue] = new("Content", Page: "DataPolicies", DefaultValue: "Value"),
        [Content.DataPoliciesSubjectEveryone] = new("Content", Page: "DataPolicies", DefaultValue: "Everyone"),
        [Content.DataPoliciesSubjectUser] = new("Content", Page: "DataPolicies", DefaultValue: "User"),
        [Content.DataPoliciesSubjectRole] = new("Content", Page: "DataPolicies", DefaultValue: "Role"),
        [Content.DataPoliciesSubjectAttribute] = new("Content", Page: "DataPolicies", DefaultValue: "Attribute"),
        [Content.DataPoliciesEffectAllow] = new("Content", Page: "DataPolicies", DefaultValue: "Allow (only matching rows are visible)"),
        [Content.DataPoliciesEffectDeny] = new("Content", Page: "DataPolicies", DefaultValue: "Deny (matching rows are excluded)"),
        [Content.DataPoliciesEffectAllowShort] = new("Content", Page: "DataPolicies", DefaultValue: "Allow"),
        [Content.DataPoliciesEffectDenyShort] = new("Content", Page: "DataPolicies", DefaultValue: "Deny"),
        [Content.DataPoliciesSelectDataSource] = new("Content", Page: "DataPolicies", DefaultValue: "— Select data source —"),
        [Content.DataPoliciesSelectTable] = new("Content", Page: "DataPolicies", DefaultValue: "— Select table —"),
        [Content.DataPoliciesSelectColumn] = new("Content", Page: "DataPolicies", DefaultValue: "— Select column —"),
        [Content.DataPoliciesSelectUser] = new("Content", Page: "DataPolicies", DefaultValue: "— Select user —"),
        [Content.DataPoliciesSelectRole] = new("Content", Page: "DataPolicies", DefaultValue: "— Select role —"),
        [Content.DataPoliciesSelectBinding] = new("Content", Page: "DataPolicies", DefaultValue: "Please select a data source, table and column."),
        [Content.DataPoliciesSelectSubject] = new("Content", Page: "DataPolicies", DefaultValue: "Please select a subject."),
        [Content.DataPoliciesNoTables] = new("Content", Page: "DataPolicies", DefaultValue: "This data source has no metadata yet; run a metadata scan first."),
        [Content.DataPoliciesAttrKey] = new("Content", Page: "DataPolicies", DefaultValue: "Attribute name"),
        [Content.DataPoliciesAttrKeyPh] = new("Content", Page: "DataPolicies", DefaultValue: "e.g. department"),
        [Content.DataPoliciesAttrKeyRequired] = new("Content", Page: "DataPolicies", DefaultValue: "Attribute name is required."),
        [Content.DataPoliciesAttrValue] = new("Content", Page: "DataPolicies", DefaultValue: "Attribute value"),
        [Content.DataPoliciesAttrValuePh] = new("Content", Page: "DataPolicies", DefaultValue: "e.g. sales"),
        [Content.DataPoliciesValuePh] = new("Content", Page: "DataPolicies", DefaultValue: "e.g. east"),
        [Content.DataPoliciesValueRequired] = new("Content", Page: "DataPolicies", DefaultValue: "Value is required."),
        [Content.DataPoliciesNullValueHint] = new("Content", Page: "DataPolicies", DefaultValue: "This operator does not take a value."),
        [Content.DataPoliciesEnabled] = new("Content", Page: "DataPolicies", DefaultValue: "Enable this policy"),
        [Content.DataPoliciesCreated] = new("Content", Page: "DataPolicies", DefaultValue: "Policy created."),
        [Content.DataPoliciesUpdated] = new("Content", Page: "DataPolicies", DefaultValue: "Policy updated."),
        [Content.DataPoliciesSaveFailed] = new("Content", Page: "DataPolicies", DefaultValue: "Save failed."),
        [Content.DataPoliciesToggleFailed] = new("Content", Page: "DataPolicies", DefaultValue: "Failed to toggle the state."),
        [Content.DataPoliciesDeleted] = new("Content", Page: "DataPolicies", DefaultValue: "Policy deleted."),
        [Content.DataPoliciesDeleteFailed] = new("Content", Page: "DataPolicies", DefaultValue: "Delete failed."),
        ...
        [Content.DashboardDesignerTitle] = new("Content", Page: "Dashboards", DefaultValue: "Dashboard designer"),
        [Content.DashboardDesignerDesc] = new("Content", Page: "Dashboards", DefaultValue: "Drag widgets on the canvas; switch to Source mode to edit the DSL directly."),
        [Content.DashboardDesignerBack] = new("Content", Page: "Dashboards", DefaultValue: "Back to list"),
        [Content.DashboardDesignerModeDesign] = new("Content", Page: "Dashboards", DefaultValue: "Design"),
        [Content.DashboardDesignerModeSource] = new("Content", Page: "Dashboards", DefaultValue: "Source"),
        [Content.DashboardDesignerModeHint] = new("Content", Page: "Dashboards", DefaultValue: "Drag a widget header to move; use the corner handle to resize."),
        [Content.DashboardDesignerSourceTitle] = new("Content", Page: "Dashboards", DefaultValue: "DSL source"),
        [Content.DashboardDesignerSourceHint] = new("Content", Page: "Dashboards", DefaultValue: "Declarative DashboardDsl (JSON). Applying returns to Design mode."),
        [Content.DashboardDesignerApply] = new("Content", Page: "Dashboards", DefaultValue: "Apply"),
        [Content.DashboardDesignerApplyInvalid] = new("Content", Page: "Dashboards", DefaultValue: "Invalid DSL JSON: {0}"),
        [Content.DashboardDesignerSave] = new("Content", Page: "Dashboards", DefaultValue: "Save"),
        [Content.DashboardDesignerSaving] = new("Content", Page: "Dashboards", DefaultValue: "Saving…"),
        [Content.DashboardDesignerSaved] = new("Content", Page: "Dashboards", DefaultValue: "Design saved."),
        [Content.DashboardDesignerSaveFailed] = new("Content", Page: "Dashboards", DefaultValue: "Save failed."),
        [Content.DashboardDesignerSaveFailedHttp] = new("Content", Page: "Dashboards", DefaultValue: "Save failed (HTTP {0})."),
        [Content.DashboardDesignerPublish] = new("Content", Page: "Dashboards", DefaultValue: "Publish"),
        [Content.DashboardDesignerPublishing] = new("Content", Page: "Dashboards", DefaultValue: "Publishing…"),
        [Content.DashboardDesignerPublished] = new("Content", Page: "Dashboards", DefaultValue: "Published version {0}."),
        [Content.DashboardDesignerPublishFailed] = new("Content", Page: "Dashboards", DefaultValue: "Publish failed."),
        [Content.DashboardDesignerPublishFailedHttp] = new("Content", Page: "Dashboards", DefaultValue: "Publish failed (HTTP {0})."),
        [Content.DashboardDesignerLoading] = new("Content", Page: "Dashboards", DefaultValue: "Loading design…"),
        [Content.DashboardDesignerLoadFailed] = new("Content", Page: "Dashboards", DefaultValue: "Load failed."),
        [Content.DashboardDesignerPalette] = new("Content", Page: "Dashboards", DefaultValue: "Widgets"),
        [Content.DashboardDesignerPaletteHint] = new("Content", Page: "Dashboards", DefaultValue: "Click to add, or drag onto the canvas."),
        [Content.DashboardDesignerCanvas] = new("Content", Page: "Dashboards", DefaultValue: "Canvas"),
        [Content.DashboardDesignerCanvasEmpty] = new("Content", Page: "Dashboards", DefaultValue: "Canvas is empty. Add widgets from the palette."),
        [Content.DashboardDesignerInspector] = new("Content", Page: "Dashboards", DefaultValue: "Properties"),
        [Content.DashboardDesignerInspectorEmpty] = new("Content", Page: "Dashboards", DefaultValue: "Select a widget to edit its properties."),
        [Content.DashboardDesignerFieldTitle] = new("Content", Page: "Dashboards", DefaultValue: "Title"),
        [Content.DashboardDesignerFieldId] = new("Content", Page: "Dashboards", DefaultValue: "Id"),
        [Content.DashboardDesignerFieldPosition] = new("Content", Page: "Dashboards", DefaultValue: "Position (x / y / w / h)"),
        [Content.DashboardDesignerFieldOrder] = new("Content", Page: "Dashboards", DefaultValue: "Order"),
        [Content.DashboardDesignerFieldQuestion] = new("Content", Page: "Dashboards", DefaultValue: "Query question"),
        [Content.DashboardDesignerFieldQuestionHint] = new("Content", Page: "Dashboards", DefaultValue: "Natural-language question; leave empty to use explicit semantics."),
        [Content.DashboardDesignerFieldChartType] = new("Content", Page: "Dashboards", DefaultValue: "Chart type"),
        [Content.DashboardDesignerFieldCategory] = new("Content", Page: "Dashboards", DefaultValue: "Category field"),
        [Content.DashboardDesignerFieldValues] = new("Content", Page: "Dashboards", DefaultValue: "Value fields"),
        [Content.DashboardDesignerFieldValuesHint] = new("Content", Page: "Dashboards", DefaultValue: "Separate multiple fields with commas."),
        [Content.DashboardDesignerFieldSeries] = new("Content", Page: "Dashboards", DefaultValue: "Series field"),
        [Content.DashboardDesignerFieldStacked] = new("Content", Page: "Dashboards", DefaultValue: "Stacked"),
        [Content.DashboardDesignerFieldLegend] = new("Content", Page: "Dashboards", DefaultValue: "Show legend"),
        [Content.DashboardDesignerFieldValue] = new("Content", Page: "Dashboards", DefaultValue: "Value field"),
        [Content.DashboardDesignerFieldFormat] = new("Content", Page: "Dashboards", DefaultValue: "Number format"),
        [Content.DashboardDesignerFieldTarget] = new("Content", Page: "Dashboards", DefaultValue: "Target"),
        [Content.DashboardDesignerFieldContent] = new("Content", Page: "Dashboards", DefaultValue: "Text content"),
        [Content.DashboardDesignerFieldLevel] = new("Content", Page: "Dashboards", DefaultValue: "Text level"),
        [Content.DashboardDesignerFieldMarkdown] = new("Content", Page: "Dashboards", DefaultValue: "Interpret as Markdown"),
        [Content.DashboardDesignerFieldField] = new("Content", Page: "Dashboards", DefaultValue: "Bound field"),
        [Content.DashboardDesignerFieldControl] = new("Content", Page: "Dashboards", DefaultValue: "Control"),
        [Content.DashboardDesignerFieldMultiple] = new("Content", Page: "Dashboards", DefaultValue: "Allow multiple"),
        [Content.DashboardDesignerFieldShowTotal] = new("Content", Page: "Dashboards", DefaultValue: "Show total"),
        [Content.DashboardDesignerFieldStriped] = new("Content", Page: "Dashboards", DefaultValue: "Striped rows"),
        [Content.DashboardDesignerFieldPageSize] = new("Content", Page: "Dashboards", DefaultValue: "Page size"),
        [Content.DashboardDesignerFieldPrompt] = new("Content", Page: "Dashboards", DefaultValue: "Insight prompt"),
        [Content.DashboardDesignerFieldMaxInsights] = new("Content", Page: "Dashboards", DefaultValue: "Max insights"),
        [Content.DashboardDesignerFieldPerspective] = new("Content", Page: "Dashboards", DefaultValue: "Perspective"),
        [Content.DashboardDesignerDelete] = new("Content", Page: "Dashboards", DefaultValue: "Delete"),
        [Content.DashboardDesignerDuplicate] = new("Content", Page: "Dashboards", DefaultValue: "Duplicate"),
        [Content.DashboardDesignerWidgetCount] = new("Content", Page: "Dashboards", DefaultValue: "{0} widgets"),
        [Content.DashboardDesignerDirty] = new("Content", Page: "Dashboards", DefaultValue: "Unsaved"),
        [Content.DashboardDesignerStatus] = new("Content", Page: "Dashboards", DefaultValue: "Status"),
        [Content.DashboardDesignerRemoved] = new("Content", Page: "Dashboards", DefaultValue: "Widget removed."),
        [Content.DashboardDesignerAdded] = new("Content", Page: "Dashboards", DefaultValue: "Widget added."),
        [Content.DashboardDesignerDropped] = new("Content", Page: "Dashboards", DefaultValue: "Widget placed."),
        [Content.DashboardDesignerWidgetChart] = new("Content", Page: "Dashboards", DefaultValue: "Chart"),
        [Content.DashboardDesignerWidgetTable] = new("Content", Page: "Dashboards", DefaultValue: "Table"),
        [Content.DashboardDesignerWidgetKpi] = new("Content", Page: "Dashboards", DefaultValue: "KPI"),
        [Content.DashboardDesignerWidgetFilter] = new("Content", Page: "Dashboards", DefaultValue: "Filter"),
        [Content.DashboardDesignerWidgetText] = new("Content", Page: "Dashboards", DefaultValue: "Text"),
        [Content.DashboardDesignerWidgetAiInsight] = new("Content", Page: "Dashboards", DefaultValue: "AI insight"),
        ...
        [Nav.DataPolicies] = new("Nav", Page: "DataPolicies", DefaultValue: "Data Policies"),
        ...
        [Content.ComponentLibraryAssets] = new("Content", Page: "ComponentGallery", DefaultValue: "Component assets"),
        [Content.ComponentLibraryLifecycleHint] = new("Content", Page: "ComponentGallery", DefaultValue: "Drafts are isolated from published state; rollback creates a new version without rewriting history."),
        [Content.ComponentLibraryNew] = new("Content", Page: "ComponentGallery", DefaultValue: "New component"),
        [Content.ComponentLibraryEmptyTitle] = new("Content", Page: "ComponentGallery", DefaultValue: "No custom components"),
        [Content.ComponentLibraryEmptyText] = new("Content", Page: "ComponentGallery", DefaultValue: "Create the first component; once published it can be reused safely by apps and dashboards."),
        [Content.ComponentLibraryType] = new("Content", Page: "ComponentGallery", DefaultValue: "Type"),
        [Content.ComponentLibraryVersion] = new("Content", Page: "ComponentGallery", DefaultValue: "Published version"),
        [Content.ComponentLibraryPublishedAt] = new("Content", Page: "ComponentGallery", DefaultValue: "Published at"),
        [Content.ComponentLibraryActions] = new("Content", Page: "ComponentGallery", DefaultValue: "Actions"),
        [Content.ComponentLibraryPreview] = new("Content", Page: "ComponentGallery", DefaultValue: "Preview"),
        [Content.ComponentLibraryVersions] = new("Content", Page: "ComponentGallery", DefaultValue: "Versions"),
        [Content.ComponentLibraryPublish] = new("Content", Page: "ComponentGallery", DefaultValue: "Publish"),
        [Content.ComponentLibraryEditTitle] = new("Content", Page: "ComponentGallery", DefaultValue: "Edit component"),
        [Content.ComponentLibraryKey] = new("Content", Page: "ComponentGallery", DefaultValue: "Component key"),
        [Content.ComponentLibraryKeyHint] = new("Content", Page: "ComponentGallery", DefaultValue: "Start with a lowercase letter; use lowercase letters, numbers, and hyphens only. The key cannot be changed after creation."),
        [Content.ComponentLibraryDescription] = new("Content", Page: "ComponentGallery", DefaultValue: "Description"),
        [Content.ComponentLibraryDsl] = new("Content", Page: "ComponentGallery", DefaultValue: "Structured DSL"),
        [Content.ComponentLibraryDslHint] = new("Content", Page: "ComponentGallery", DefaultValue: "Only allowlisted structures are supported; HTML, CSS, and JavaScript are rejected."),
        [Content.ComponentLibrarySaving] = new("Content", Page: "ComponentGallery", DefaultValue: "Saving…"),
        [Content.ComponentLibraryPreviewTitle] = new("Content", Page: "ComponentGallery", DefaultValue: "Published component preview"),
        [Content.ComponentLibraryVersionHistory] = new("Content", Page: "ComponentGallery", DefaultValue: "Published version history"),
        [Content.ComponentLibraryNoVersions] = new("Content", Page: "ComponentGallery", DefaultValue: "This component has not been published."),
        [Content.ComponentLibraryCurrent] = new("Content", Page: "ComponentGallery", DefaultValue: "Current"),
        [Content.ComponentLibraryRollback] = new("Content", Page: "ComponentGallery", DefaultValue: "Roll back to this version"),
        [Content.ComponentLibraryDeleteConfirm] = new("Content", Page: "ComponentGallery", DefaultValue: "Deleting this component also deletes all its versions. Continue?"),
        [Content.ComponentLibraryLoadFailed] = new("Content", Page: "ComponentGallery", DefaultValue: "Failed to load component."),
        [Content.ComponentLibraryInvalidForm] = new("Content", Page: "ComponentGallery", DefaultValue: "Enter a name and a valid component key."),
        [Content.ComponentLibraryInvalidDsl] = new("Content", Page: "ComponentGallery", DefaultValue: "Invalid DSL: {0}"),
        [Content.ComponentLibrarySaveFailed] = new("Content", Page: "ComponentGallery", DefaultValue: "Failed to save component."),
        [Content.ComponentLibrarySaved] = new("Content", Page: "ComponentGallery", DefaultValue: "Component saved."),
        [Content.ComponentLibraryPublishFailed] = new("Content", Page: "ComponentGallery", DefaultValue: "Failed to publish component."),
        [Content.ComponentLibraryPublished] = new("Content", Page: "ComponentGallery", DefaultValue: "Component published."),
        [Content.ComponentLibraryUnpublished] = new("Content", Page: "ComponentGallery", DefaultValue: "The component is not published, so no runtime preview is available."),
        [Content.ComponentLibraryRollbackFailed] = new("Content", Page: "ComponentGallery", DefaultValue: "Failed to roll back component."),
        [Content.ComponentLibraryRollbackDone] = new("Content", Page: "ComponentGallery", DefaultValue: "Rolled back and created a new published version."),
        [Content.ComponentLibraryDeleteFailed] = new("Content", Page: "ComponentGallery", DefaultValue: "Failed to delete component."),
        [Content.ComponentLibraryDeleted] = new("Content", Page: "ComponentGallery", DefaultValue: "Component deleted."),
        ...
        [Content.AskTurnDrill] = new("Content", Page: "AskTurn", DefaultValue: "Filter: "),
        [Content.AskTurnClearDrill] = new("Content", Page: "AskTurn", DefaultValue: "Clear filter"),
        ...
        [Content.AppsDesignerTitle] = new("Content", Page: "Apps", DefaultValue: "App Designer"),
        [Content.AppsDesignerLoading] = new("Content", Page: "Apps", DefaultValue: "Loading app designer…"),
        [Content.AppsDesignerLoadFailed] = new("Content", Page: "Apps", DefaultValue: "Failed to load the app."),
        [Content.AppsDesignerSave] = new("Content", Page: "Apps", DefaultValue: "Save"),
        [Content.AppsDesignerSaving] = new("Content", Page: "Apps", DefaultValue: "Saving…"),
        [Content.AppsDesignerSaved] = new("Content", Page: "Apps", DefaultValue: "App saved."),
        [Content.AppsDesignerSaveFailed] = new("Content", Page: "Apps", DefaultValue: "Save failed (HTTP {0})."),
        [Content.AppsDesignerPublish] = new("Content", Page: "Apps", DefaultValue: "Publish"),
        [Content.AppsDesignerPublishing] = new("Content", Page: "Apps", DefaultValue: "Publishing…"),
        [Content.AppsDesignerPublished] = new("Content", Page: "Apps", DefaultValue: "Published version {0}."),
        [Content.AppsDesignerPublishFailed] = new("Content", Page: "Apps", DefaultValue: "Publish failed (HTTP {0})."),
        [Content.AppsDesignerDesignMode] = new("Content", Page: "Apps", DefaultValue: "Design"),
        [Content.AppsDesignerSourceMode] = new("Content", Page: "Apps", DefaultValue: "Source"),
        [Content.AppsDesignerAppName] = new("Content", Page: "Apps", DefaultValue: "App name"),
        [Content.AppsDesignerAppDescription] = new("Content", Page: "Apps", DefaultValue: "Description"),
        [Content.AppsDesignerTheme] = new("Content", Page: "Apps", DefaultValue: "Theme"),
        [Content.AppsDesignerThemeDefault] = new("Content", Page: "Apps", DefaultValue: "Tenant default theme"),
        [Content.AppsDesignerTreeTitle] = new("Content", Page: "Apps", DefaultValue: "Component Tree"),
        [Content.AppsDesignerPages] = new("Content", Page: "Apps", DefaultValue: "Pages"),
        [Content.AppsDesignerAddPage] = new("Content", Page: "Apps", DefaultValue: "Add page"),
        [Content.AppsDesignerAddComponent] = new("Content", Page: "Apps", DefaultValue: "Add component"),
        [Content.AppsDesignerDelete] = new("Content", Page: "Apps", DefaultValue: "Delete"),
        [Content.AppsDesignerDuplicate] = new("Content", Page: "Apps", DefaultValue: "Duplicate"),
        [Content.AppsDesignerNoSelection] = new("Content", Page: "Apps", DefaultValue: "No component selected. Select one on the canvas or the tree to edit its properties."),
        [Content.AppsDesignerEmptyApp] = new("Content", Page: "Apps", DefaultValue: "This app has no pages yet. Click \"Add page\" to start."),
        [Content.AppsDesignerSectionGeneral] = new("Content", Page: "Apps", DefaultValue: "General"),
        [Content.AppsDesignerSectionBinding] = new("Content", Page: "Apps", DefaultValue: "Data Binding"),
        [Content.AppsDesignerSectionProperties] = new("Content", Page: "Apps", DefaultValue: "Presentation"),
        [Content.AppsDesignerSectionStyle] = new("Content", Page: "Apps", DefaultValue: "Style"),
        [Content.AppsDesignerSectionPermissions] = new("Content", Page: "Apps", DefaultValue: "Permissions"),
        [Content.AppsDesignerFieldType] = new("Content", Page: "Apps", DefaultValue: "Type"),
        [Content.AppsDesignerFieldId] = new("Content", Page: "Apps", DefaultValue: "Id"),
        [Content.AppsDesignerFieldTitle] = new("Content", Page: "Apps", DefaultValue: "Title"),
        [Content.AppsDesignerFieldOrder] = new("Content", Page: "Apps", DefaultValue: "Order"),
        [Content.AppsDesignerFieldPosition] = new("Content", Page: "Apps", DefaultValue: "Position (X/Y/W/H)"),
        [Content.AppsDesignerFieldEntity] = new("Content", Page: "Apps", DefaultValue: "Entity"),
        [Content.AppsDesignerFieldDataSourceId] = new("Content", Page: "Apps", DefaultValue: "Data source id"),
        [Content.AppsDesignerFieldTableId] = new("Content", Page: "Apps", DefaultValue: "Table id"),
        [Content.AppsDesignerFieldMetrics] = new("Content", Page: "Apps", DefaultValue: "Metrics"),
        [Content.AppsDesignerFieldDimensions] = new("Content", Page: "Apps", DefaultValue: "Dimensions"),
        [Content.AppsDesignerFieldFilters] = new("Content", Page: "Apps", DefaultValue: "Filters"),
        [Content.AppsDesignerFieldSort] = new("Content", Page: "Apps", DefaultValue: "Sort"),
        [Content.AppsDesignerFieldLimit] = new("Content", Page: "Apps", DefaultValue: "Row limit"),
        [Content.AppsDesignerFieldAggregation] = new("Content", Page: "Apps", DefaultValue: "Aggregation"),
        [Content.AppsDesignerFieldOperator] = new("Content", Page: "Apps", DefaultValue: "Operator"),
        [Content.AppsDesignerFieldValue] = new("Content", Page: "Apps", DefaultValue: "Value"),
        [Content.AppsDesignerFieldDirection] = new("Content", Page: "Apps", DefaultValue: "Direction"),
        [Content.AppsDesignerFieldPalette] = new("Content", Page: "Apps", DefaultValue: "Palette"),
        [Content.AppsDesignerFieldBackground] = new("Content", Page: "Apps", DefaultValue: "Background"),
        [Content.AppsDesignerFieldShowBorder] = new("Content", Page: "Apps", DefaultValue: "Show border"),
        [Content.AppsDesignerFieldPadding] = new("Content", Page: "Apps", DefaultValue: "Padding"),
        [Content.AppsDesignerTypeChart] = new("Content", Page: "Apps", DefaultValue: "Chart"),
        [Content.AppsDesignerTypeTable] = new("Content", Page: "Apps", DefaultValue: "Table"),
        [Content.AppsDesignerTypeKpi] = new("Content", Page: "Apps", DefaultValue: "KPI"),
        [Content.AppsDesignerTypeText] = new("Content", Page: "Apps", DefaultValue: "Text"),
        [Content.AppsDesignerTypeFilter] = new("Content", Page: "Apps", DefaultValue: "Filter"),
        [Content.AppsDesignerTypeForm] = new("Content", Page: "Apps", DefaultValue: "Form"),
        [Content.AppsDesignerPermissionsHint] = new("Content", Page: "Apps", DefaultValue: "App access is governed by tenant RBAC: view=app:view, edit=app:edit, publish=app:publish, delete=app:delete. Permissions are assigned via tenant roles, not inside the app DSL."),
        [Content.AppsDesignerSourceHint] = new("Content", Page: "Apps", DefaultValue: "Edit the AppDsl JSON directly. It is validated before saving."),
        [Content.AppsDesignerSourceInvalid] = new("Content", Page: "Apps", DefaultValue: "JSON parse failed: {0}"),
        ...
        [Content.AgentRunTitle] = new("Content", Page: "Agent", DefaultValue: "Agent Run"),
        [Content.AgentRunDesc] = new("Content", Page: "Agent", DefaultValue: "View a single run's execution history, tool calls, duration and errors."),
        [Content.AgentRunLoadingText] = new("Content", Page: "Agent", DefaultValue: "Loading run…"),
        [Content.AgentRunNotFound] = new("Content", Page: "Agent", DefaultValue: "Run record not found."),
        [Content.AgentRunLoadError] = new("Content", Page: "Agent", DefaultValue: "Failed to load run: {0}"),
        [Content.AgentRunInfoPanel] = new("Content", Page: "Agent", DefaultValue: "Run Info"),
        [Content.AgentRunPlanCode] = new("Content", Page: "Agent", DefaultValue: "Agent"),
        [Content.AgentRunStatus] = new("Content", Page: "Agent", DefaultValue: "Status"),
        [Content.AgentRunActor] = new("Content", Page: "Agent", DefaultValue: "Actor"),
        [Content.AgentRunStarted] = new("Content", Page: "Agent", DefaultValue: "Started"),
        [Content.AgentRunFinished] = new("Content", Page: "Agent", DefaultValue: "Finished"),
        [Content.AgentRunDuration] = new("Content", Page: "Agent", DefaultValue: "Duration"),
        [Content.AgentRunResultSummary] = new("Content", Page: "Agent", DefaultValue: "Result Summary"),
        [Content.AgentRunSteps] = new("Content", Page: "Agent", DefaultValue: "Execution History"),
        [Content.AgentRunNoSteps] = new("Content", Page: "Agent", DefaultValue: "No step records for this run."),
        [Content.AgentRunStepSucceeded] = new("Content", Page: "Agent", DefaultValue: "Succeeded"),
        [Content.AgentRunStepFailed] = new("Content", Page: "Agent", DefaultValue: "Failed"),
        [Content.AgentRunStepPendingApproval] = new("Content", Page: "Agent", DefaultValue: "Awaiting approval"),
        [Content.AgentRunStepAttempts] = new("Content", Page: "Agent", DefaultValue: "Attempts"),
        [Content.AgentRunStepOutput] = new("Content", Page: "Agent", DefaultValue: "Output"),
        [Content.AgentRunStepError] = new("Content", Page: "Agent", DefaultValue: "Error"),
        [Content.AgentRunApprove] = new("Content", Page: "Agent", DefaultValue: "Approve"),
        [Content.AgentRunReject] = new("Content", Page: "Agent", DefaultValue: "Reject"),
        [Content.AgentRunApproveSuccess] = new("Content", Page: "Agent", DefaultValue: "Approved; resuming execution."),
        [Content.AgentRunRejectSuccess] = new("Content", Page: "Agent", DefaultValue: "Rejected; run terminated."),
        [Content.AgentRunActionFailed] = new("Content", Page: "Agent", DefaultValue: "Action failed: {0}"),
        [Content.AgentRunStatusQueued] = new("Content", Page: "Agent", DefaultValue: "Queued"),
        [Content.AgentRunStatusRunning] = new("Content", Page: "Agent", DefaultValue: "Running"),
        [Content.AgentRunStatusSucceeded] = new("Content", Page: "Agent", DefaultValue: "Succeeded"),
        [Content.AgentRunStatusFailed] = new("Content", Page: "Agent", DefaultValue: "Failed"),
        [Content.AgentRunStatusApprovalPending] = new("Content", Page: "Agent", DefaultValue: "Approval Pending"),
        [Content.AgentRunStatusApproved] = new("Content", Page: "Agent", DefaultValue: "Approved"),
        [Content.AgentRunStatusRejected] = new("Content", Page: "Agent", DefaultValue: "Rejected"),
        [Content.AgentRunRiskSafe] = new("Content", Page: "Agent", DefaultValue: "Safe"),
        [Content.AgentRunRiskRead] = new("Content", Page: "Agent", DefaultValue: "Read"),
        [Content.AgentRunRiskWrite] = new("Content", Page: "Agent", DefaultValue: "Write"),
        [Content.AgentRunModeControlled] = new("Content", Page: "Agent", DefaultValue: "Controlled"),
        [Content.AgentRunModeLive] = new("Content", Page: "Agent", DefaultValue: "Live"),
        ...
        [Content.OnboardingTitle] = new("Content", Page: "Home", DefaultValue: "Get started"),
        [Content.OnboardingDesc] = new("Content", Page: "Home", DefaultValue: "Follow this checklist to complete your first onboarding—from a blank tenant to your first analysis result."),
        [Content.OnboardingProgress] = new("Content", Page: "Home", DefaultValue: "Progress"),
        [Content.OnboardingBlankTitle] = new("Content", Page: "Home", DefaultValue: "Welcome—connect your first data source"),
        [Content.OnboardingBlankText] = new("Content", Page: "Home", DefaultValue: "Complete the steps below to ask in natural language and turn results into dashboards or apps."),
        [Content.OnbConnectTitle] = new("Content", Page: "Home", DefaultValue: "Connect a data source (connect + authorize)"),
        [Content.OnbConnectDesc] = new("Content", Page: "Home", DefaultValue: "Register a database in Data Source Management and test the connection; saving auto-grants access to the current admin."),
        [Content.OnbConnectFailed] = new("Content", Page: "Home", DefaultValue: "Connection test failed—retest the connection."),
        [Content.OnbScanTitle] = new("Content", Page: "Home", DefaultValue: "Scan metadata"),
        [Content.OnbScanDesc] = new("Content", Page: "Home", DefaultValue: "Run a metadata scan to automatically recognize tables and columns."),
        [Content.OnbScanRetry] = new("Content", Page: "Home", DefaultValue: "Connected but not yet scanned—rescan."),
        [Content.OnbSemanticTitle] = new("Content", Page: "Home", DefaultValue: "Confirm business semantics (entities / metrics)"),
        [Content.OnbSemanticDesc] = new("Content", Page: "Home", DefaultValue: "Review entities and metrics in the Semantic Model so the AI understands your business terms."),
        [Content.OnbAskTitle] = new("Content", Page: "Home", DefaultValue: "Ask your first question"),
        [Content.OnbAskDesc] = new("Content", Page: "Home", DefaultValue: "Open Ask BI Smart Q&A and ask your first question; review the result and generated SQL."),
        [Content.OnbSaveTitle] = new("Content", Page: "Home", DefaultValue: "Save your first result"),
        [Content.OnbSaveDesc] = new("Content", Page: "Home", DefaultValue: "Publish a satisfying Q&A as a dashboard or app for your team to reuse."),
        [Content.OnbSampleTitle] = new("Content", Page: "Home", DefaultValue: "(Optional) Load sample industry data"),
        [Content.OnbSampleDesc] = new("Content", Page: "Home", DefaultValue: "Install a demo tenant with sample data to explore quickly; delete the demo tenant anytime to clean up."),
        [Content.OnbGo] = new("Content", Page: "Home", DefaultValue: "Go"),
        [Content.OnbDone] = new("Content", Page: "Home", DefaultValue: "Done"),
        [Content.OnbRetry] = new("Content", Page: "Home", DefaultValue: "Retry"),
