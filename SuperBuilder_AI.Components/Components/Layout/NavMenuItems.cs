    ...
    public static IReadOnlyList<NavGroup> Groups { get; } = new[]
    {
        ...
        new NavGroup
        {
            ...
            Items = new[]
            {
                ...
                new NavItem { Href = "admin/self-registration", Title = "自助注册", Icon = "sb-ico-tenant", Permission = PermissionCodes.PlatformAdminManage },
                new NavItem { Href = "admin/demo-data", Title = "演示数据", Icon = "sb-ico-db", Permission = PermissionCodes.PlatformAdminManage },
